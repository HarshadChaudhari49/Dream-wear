...
import { fetchBanners, fetchProducts, fetchProductDetail, saveProduct } from "./api";

export function useBanners() {
  return useQuery({ queryKey: ["banners"], queryFn: fetchBanners });
}

export function useProducts(params?: { category?: string; ordering?: string; search?: string }) {
